    ...
    return {
        ...
        execute: function() {
            SettingsAddUser = (function () {
                ...
                Object.defineProperty(SettingsAddUser.prototype, "table", {
                ...
                SettingsAddUser.prototype.showByDay = function () {
                    // alert('by day');
                    this.currentTable = this.tableByday;
                    this.currentSelect = this.months;
                    this.initSelect();
                };
                SettingsAddUser.prototype.showByMonth = function () {
                    //  alert('by month');
                ...
                ], SettingsAddUser.prototype, "table", null);
