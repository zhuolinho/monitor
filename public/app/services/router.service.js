System.register(["@angular/router", "../components/login/login.component", "../components/admin/admin.component", "../components/home/home.component", "../components/monitor/monitor.component", "../components/gps/gps.component", "../components/settings/settings.component", "../components/home/alerts/home.alerts.component", "../components/home/alerts_processed/home.alerts.processed.component", "../components/gps/map/shipment-map.component", "../components/gps/processed/processed-shipment.component", "../components/gps/shipment/shiment.component", "../components/monitor/gas/gas.component", "../components/monitor/camera/camera.component", "../components/monitor/gas-stats/gas-stats.component", "../components/settings/sms/settings-sms.component", "../components/settings/auth/settings-auth.component", "../components/settings/access/settings-access.component", "../components/settings/address/settings-address.component", "../components/settings/formula/settings-formula.component", "../components/settings/offline_users/settings-offline-users.component"], function (exports_1, context_1) {
    ...
    var router_1, login_component_1, admin_component_1, home_component_1, monitor_component_1, gps_component_1, settings_component_1, home_alerts_component_1, home_alerts_processed_component_1, shipment_map_component_1, processed_shipment_component_1, shiment_component_1, gas_component_1, camera_component_1, gas_stats_component_1, settings_sms_component_1, settings_auth_component_1, settings_access_component_1, settings_address_component_1, settings_formula_component_1, settings_offline_users_component_1, ROUTES, globalRouting;
    return {
        setters: [
            function (router_1_1) {
                router_1 = router_1_1;
